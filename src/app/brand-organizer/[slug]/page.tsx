...
export default function BrandCityDashboard() {
          ...
          <div style={{ marginTop: "6px", background: "#faf8f5", borderRadius: "8px", padding: "8px", border: "1px solid #f0ebe4" }}>
            {itemComments.map(c => (
              <div key={c.id} style={{ marginBottom: "6px", padding: "6px 8px", background: "#fff", borderRadius: "6px", borderLeft: c.sender_email === userEmail ? "2px solid #b87333" : "2px solid #e8e0d5" }}>
                ...
                <div style={{ fontSize: "0.82rem", color: "#4a3728" }}>{c.message}</div>
              </div>
            ))}
            <div style={{ display: "flex", gap: "6px", marginTop: "6px" }}>
              ...
              <button onClick={() => sendComment(itemName)} style={{ padding: "5px 10px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "6px", fontSize: "0.75rem", cursor: "pointer" }}>Send</button>
            </div>
          </div>
        )}
      </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#faf7f4", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ position: "fixed", top: 0, left: 0, bottom: 0, width: "240px", background: "#4a3728", zIndex: 16, transform: sidebarOpen ? "translateX(0)" : "translateX(-100%)", transition: "transform 0.3s ease", display: "flex", flexDirection: "column" as const }}>
        <div style={{ padding: "2rem 1.5rem 1.5rem", borderBottom: "1px solid #5a4535" }}>
        ...
        <nav style={{ flex: 1, padding: "1rem 0" }}>
          {tabs.map(tab => (
            <a key={tab.key} onClick={() => { setActiveTab(tab.key as any); setSidebarOpen(false); }} style={{ display: "flex", alignItems: "center", padding: "12px 1.5rem", fontSize: "0.82rem", color: activeTab === tab.key ? "#fff" : "#8b6a4a", background: activeTab === tab.key ? "#5a4535" : "transparent", textDecoration: "none", borderLeft: activeTab === tab.key ? "2px solid #c8a882" : "2px solid transparent", cursor: "pointer", letterSpacing: "0.05em", transition: "all 0.15s" }}>
              {tab.label}
            </a>
          ))}
        </nav>
        <div style={{ padding: "1.5rem", borderTop: "1px solid #5a4535" }}>
          <Link href="/brand-organizer" style={{ fontSize: "0.75rem", color: "#8b6a4a", textDecoration: "none", letterSpacing: "0.08em" }}>← ALL CITIES</Link>
        </div>
      </div>

      <div style={{ background: "#4a3728", padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "1rem", position: "sticky" as const, top: 0, zIndex: 14 }}>
      ...
      <div style={{ padding: "2rem 2.5rem", maxWidth: "1000px", margin: "0 auto" }}>
        ...
        {activeTab === "overview" && (
          <div>
            {/* Hero stats */}
            <div style={{ background: "#4a3728", borderRadius: "20px", padding: "2.5rem", marginBottom: "2rem", color: "#fff", position: "relative" as const, overflow: "hidden" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "2rem", alignItems: "start" }}>
                ...
                <div style={{ background: "#fff", borderRadius: "12px", padding: "1.25rem", textAlign: "center" as const }}>
                  <div style={{ fontSize: "3rem", color: "#4a3728", lineHeight: 1, fontWeight: "normal" }}>{daysToEvent ?? "—"}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
              <div style={{ background: "#fff", borderRadius: "14px", padding: "1.5rem", border: "1px solid #ede8e2" }}>
                ...
                {editingPlannerName ? (
                  <div style={{ display: "flex", gap: "6px" }}>
                    ...
                    <button onClick={savePlannerName} style={{ padding: "5px 8px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "6px", fontSize: "0.75rem", cursor: "pointer" }}>✓</button>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div style={{ fontSize: "1rem", color: "#4a3728" }}>{plannerDisplay}</div>
              ...
              <div style={{ background: "#fff", borderRadius: "14px", padding: "1.5rem", border: "1px solid #ede8e2" }}>
                ...
                <div style={{ fontSize: "1.4rem", color: "#4a3728", marginBottom: "4px" }}>{shipments.filter(s => s.shipped).length}/{shipments.length}</div>
          ...
          <div>
            <div style={{ display: "flex", gap: "8px", marginBottom: "2rem" }}>
              {(["decor", "refreshments", "staff"] as const).map(t => (
                <button key={t} onClick={() => setPlanningTab(t)} style={{ padding: "8px 24px", background: planningTab === t ? "#4a3728" : "#fff", color: planningTab === t ? "#fff" : "#8b7355", border: "1px solid " + (planningTab === t ? "#4a3728" : "#ede8e2"), borderRadius: "30px", fontSize: "0.78rem", cursor: "pointer", fontFamily: "Georgia, serif", textTransform: "capitalize" as const, letterSpacing: "0.08em" }}>{t}</button>
              ))}
            </div>
        ...
        {activeTab === "budget" && (
          <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
                ...
                {editingBudget ? (
                  <div style={{ display: "flex", gap: "6px" }}>
                    ...
                    <button onClick={saveBudget} style={{ padding: "5px 10px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "6px", fontSize: "0.78rem", cursor: "pointer" }}>Save</button>
            ...
            <div style={{ background: "#4a3728", borderRadius: "14px", padding: "1rem 1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ background: "#fff", borderRadius: "14px", padding: "1.5rem", border: "1px solid #ede8e2" }}>
              ...
              <div style={{ display: "flex", gap: "8px", marginBottom: "1rem", flexWrap: "wrap" as const }}>
                ...
                <button onClick={addMyTask} style={{ padding: "8px 16px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "8px", fontSize: "0.82rem", cursor: "pointer" }}>Add</button>
              </div>
        ...
        {activeTab === "shipments" && (
          <div style={{ background: "#fff", borderRadius: "14px", padding: "1.5rem", border: "1px solid #ede8e2" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
              ...
              <button onClick={() => setAddingShipment(true)} style={{ padding: "6px 14px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "8px", fontSize: "0.78rem", cursor: "pointer" }}>+ Add</button>
            </div>
            {addingShipment && (
              <div style={{ display: "flex", gap: "8px", marginBottom: "1rem" }}>
                ...
                <button onClick={addShipment} style={{ padding: "6px 12px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "8px", fontSize: "0.78rem", cursor: "pointer" }}>Save</button>
        ...
        {activeTab === "chat" && (
          <div style={{ background: "#fff", borderRadius: "14px", padding: "1.5rem", border: "1px solid #ede8e2" }}>
              ...
              {messages.map(msg => {
                ...
                return (
                  <div key={msg.id} style={{ display: "flex", flexDirection: "column" as const, alignItems: isMe ? "flex-end" : "flex-start" }}>
                    ...
                    <div style={{ maxWidth: "70%", padding: "10px 16px", borderRadius: isMe ? "16px 16px 4px 16px" : "16px 16px 16px 4px", background: isMe ? "#4a3728" : "#f5f2ee", color: isMe ? "#fff" : "#2c1810", fontSize: "0.88rem", lineHeight: 1.6 }}>{msg.message}</div>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button onClick={sendMessage} style={{ padding: "8px 20px", background: "#4a3728", color: "#fff", border: "none", borderRadius: "8px", fontSize: "0.85rem", cursor: "pointer" }}>Send</button>
            </div>
          </div>
        )}
