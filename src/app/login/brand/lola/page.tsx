...
const brand = {
  name: "Lola Signatures",
  email: "lolasignatures@gmail.com",
  event: "Atlanta",
...
const faqs = [
  { q: "Do I need to attend the pop-up in person?", a: "No — AO Curates will fully staff the store with trained sales associates. You do not need to send a representative. Our team will be briefed using your brand book and product details." },
  { q: "When will I receive my payout?", a: "Payouts will be issued by October 5th, 2026. A final inventory list will also be sent to you by the same date so you know exactly what sold." },
  { q: "What is the commission structure?", a: "AO Curates applies a 20% commission on all sales made during the pop-up. Your payout will reflect your total sales minus the 20% commission." },
  { q: "What happens to unsold items?", a: "Unsold items must either be picked up by October 31st, 2026 or shipped back at the brand's expense. We will coordinate with you after the event." },
  { q: "How many units can I send?", a: "Brands may ship up to 50 units total. However all units must fall within the AO Curates approved selection based on your catalogue review." },
  { q: "What shipping options are available?", a: "You may use any courier of your choice. AO Curates has secured an affordable bulk shipping option from Lagos to Atlanta through Amgray Logistics at 17,500 per kg. Products must arrive in Atlanta between August 3rd and August 28th, 2026." },
  ...
  { q: "What marketing support does AO Curates provide?", a: "AO Curates will provide high-quality graphics, event posters, customizable social media templates and official event talking points. We will also run paid Instagram ads, organic content, email marketing campaigns and a public Opening Day event." },
  { q: "What are my marketing responsibilities?", a: "Each brand is expected to post the provided promotional asset on their Instagram feed, share at least one Instagram Story featuring the provided materials, and communicate the event details to their audience." },
  { q: "What is the Digital Brand Book and when is it due?", a: "The Digital Brand Book is due two weeks before the pop-up around August 28th, 2026. Please include your brand story, founder bio, product details, care instructions, brand values and any key selling points for our associates." },
  { q: "What labelling is required on my products?", a: "Every single item must be tagged before shipping with your brand name, product name and selling price. Items that are not properly tagged may experience delays in being displayed for sale." },
  { q: "Who do I contact if I have questions?", a: "Once participation is confirmed you will be added to a private WhatsApp group where you can reach the AO Curates team directly for any questions or updates." },
];
...
export default function LolaPortal() {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      const [deadlineRes, taskRes] = await Promise.all([
        supabase.from("event_deadlines").select("*").eq("event", "Atlanta").order("id"),
        supabase.from("brand_tasks").select("*").eq("brand_email", brand.email).eq("event", "Atlanta"),
      ]);
    ...
    <div style={{ minHeight: "100vh", background: "#f5f0ea", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        ...
        <div style={{ background: "#2c1810", borderRadius: "12px", padding: "1.5rem 2rem", marginBottom: "1.5rem", color: "#fff", display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "1rem", alignItems: "center" }}>
          <div><div style={{ fontSize: "0.7rem", color: "#c8b89a", marginBottom: "4px" }}>PARTICIPATION FEE</div><div style={{ fontSize: "1.4rem" }}>${brand.feeOwed}</div></div>
          <div><div style={{ fontSize: "0.7rem", color: "#c8b89a", marginBottom: "4px" }}>PAID</div><div style={{ fontSize: "1.4rem" }}>${brand.amountPaid}</div></div>
          <div><div style={{ fontSize: "0.7rem", color: "#c8b89a", marginBottom: "4px" }}>BALANCE</div><div style={{ fontSize: "1.4rem", color: brand.balance > 0 ? "#e8c97a" : "#90c9a0" }}>${brand.balance}</div></div>
        ...
        <div style={{ background: "#fff", borderRadius: "12px", padding: "1.5rem", marginBottom: "1.5rem", border: "1px solid #e8e0d5" }}>
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" as const }}>
            ...
            <a href="https://drive.google.com/drive/folders/1TlFJQaIxQAz57whz3DeuSgjUt5EteYY5?usp=share_link" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "10px 20px", background: "#4a7c59", color: "#fff", borderRadius: "8px", fontSize: "0.85rem", textDecoration: "none", fontFamily: "Georgia, serif" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "12px", padding: "1.5rem", marginBottom: "1.5rem", border: "1px solid #e8e0d5" }}>
          ...
          <div style={{ background: "#faf8f5", borderRadius: "10px", padding: "1.25rem", border: "1px solid #e8e0d5", marginBottom: "1.25rem" }}>
            ...
            <div style={{ fontSize: "0.9rem", color: "#2c1810", marginBottom: "1rem" }}>Lola Signatures — AO Curates Atlanta 2026</div>
            <a href="https://drive.google.com/drive/folders/1TlFJQaIxQAz57whz3DeuSgjUt5EteYY5?usp=share_link" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "10px 20px", background: "#2c1810", color: "#fff", borderRadius: "8px", fontSize: "0.85rem", textDecoration: "none", fontFamily: "Georgia, serif" }}>
