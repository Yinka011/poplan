...
const faqs = [
  ...
  { q: "What are the event hours?", a: "Friday September 11th is a Private Shopping Event from 5PM–7PM. Saturday September 12th is open 10AM–6PM. Sunday September 13th is open 12PM–5PM." },
  ...
  { q: "What are my marketing responsibilities?", a: "Each brand is expected to post the provided promotional asset on their Instagram feed, share at least one Instagram Story featuring the provided materials, and communicate the event details to their US and Atlanta-based audience." },
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "12px", padding: "1.5rem", marginBottom: "1.5rem", border: "1px solid #e8e0d5" }}>
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" as const }}>
            ...
            <a href="https://drive.google.com/drive/folders/1WloEj6iDYNu41vaF0f1St5UAKx95SNgy?usp=share_link" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "10px 20px", background: "#4a7c59", color: "#fff", borderRadius: "8px", fontSize: "0.85rem", textDecoration: "none", fontFamily: "Georgia, serif" }}>📤 Upload completed sheet</a>
          </div>
        </div>
        ...
        <div style={{ background: "#fff", borderRadius: "12px", padding: "1.5rem", marginBottom: "1.5rem", border: "1px solid #e8e0d5" }}>
          ...
          <div style={{ background: "#faf8f5", borderRadius: "10px", padding: "1.25rem", border: "1px solid #e8e0d5", marginBottom: "1.25rem" }}>
            ...
            <a href="https://drive.google.com/drive/folders/1WloEj6iDYNu41vaF0f1St5UAKx95SNgy?usp=share_link" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "10px 20px", background: "#2c1810", color: "#fff", borderRadius: "8px", fontSize: "0.85rem", textDecoration: "none", fontFamily: "Georgia, serif" }}>📁 Open my upload folder</a>
          </div>
