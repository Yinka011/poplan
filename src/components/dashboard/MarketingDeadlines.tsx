import { MARKETING_DEADLINES, formatDate } from "@/lib/organizer-data";
...
export function MarketingDeadlines() {
  return (
    <section className="rounded-2xl border border-nude-300/50 bg-white/70 p-6 shadow-sm backdrop-blur-sm">
      <div>
        ...
        <p className="mt-0.5 text-sm text-brown-600/60">
          Upcoming campaigns for Atlanta
        </p>
      </div>

      <ul className="mt-5 space-y-3">
        {MARKETING_DEADLINES.map((item) => {
