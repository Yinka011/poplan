    ...
    <body style="margin:0;padding:0;background:#f8faf8;font-family:Georgia,serif;">
      <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
        ...
        <div style="background:#fff;border-radius:16px;padding:32px;border:1px solid #e4ebe6;">
          ...
          <a href="${buttonUrl}" style="display:inline-block;padding:10px 24px;background:#1B3A2D;color:#fff;text-decoration:none;border-radius:8px;font-size:0.9rem;font-family:Georgia,serif;">
            ${buttonText}
          </a>
          ` : ""}
        </div>
        ...
        <div style="text-align:center;margin-top:24px;font-size:0.78rem;color:#4a5a52;">
          ...
          <br>
          <a href="https://nalpop.com" style="color:#E8C97A;text-decoration:none;">nalpop.com</a>
        </div>
